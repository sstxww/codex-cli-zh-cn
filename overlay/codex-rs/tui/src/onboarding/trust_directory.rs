...
impl WidgetRef for &TrustDirectoryWidget {
    fn render_ref(&self, area: Rect, buf: &mut Buffer) {
        ...
        column.push(Line::from(vec![
            "> ".into(),
            crate::i18n::tr_static("You are in ").bold(),
        ...
        if self.cwd != self.trust_target {
            ...
            let git_root_warning = Paragraph::new(crate::i18n::tr_owned(format!(
        ...
        column.push(
            Paragraph::new(crate::i18n::tr_owned(
        ...
        let options: Vec<(&str, TrustDirectorySelection)> = vec![
            (
                crate::i18n::tr_static("Yes, continue"),
                TrustDirectorySelection::Trust,
            ),
            (
                crate::i18n::tr_static("No, quit"),
        ...
        column.push(
            Line::from(vec![
                ...
                if self.show_windows_create_sandbox_hint {
                    crate::i18n::tr_static(" to continue and create a sandbox...").dim()
                } else {
                    crate::i18n::tr_static(" to continue").dim()
                },
            ])
            .inset(Insets::tlbr(
                /*top*/ 0, /*left*/ 2, /*bottom*/ 0, /*right*/ 0,
