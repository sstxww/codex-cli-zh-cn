...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        ...
        let create_mode_item = |idx: usize,
         ...
         -> Vec<Line<'static>> {
            ...
            let text = crate::i18n::tr_owned(text);
            let description = crate::i18n::tr_owned(description);
    ...
    fn render_continue_in_browser(&self, area: Rect, buf: &mut Buffer) {
        ...
        if self.animations_enabled && !self.animations_suppressed.get() {
            ...
            spans.extend(shimmer_text(
                crate::i18n::tr_static("Finish signing in via your browser"),
                MotionMode::Animated,
            ));
        } else {
            spans.push(crate::i18n::tr_static("Finish signing in via your browser").into());
        }
    ...
    fn render_api_key_entry(&self, area: Rect, buf: &mut Buffer, state: &ApiKeyInputState) {
        ...
        let content_line: Line = if state.value.is_empty() {
            vec![crate::i18n::tr_static("Paste or type your API key").dim()].into()
        } else {
        ...
        Paragraph::new(content_line)
            ...
            .block(
                Block::default()
                    .title(crate::i18n::tr_static("API key"))
                    .borders(Borders::ALL)
