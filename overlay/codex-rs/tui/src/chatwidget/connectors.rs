...
impl ChatWidget {
    ...
    fn connectors_loading_popup_params(&self) -> SelectionViewParams {
        ...
        header.push(Line::from(crate::i18n::tr_static("Apps").bold()));
        header.push(Line::from(
            crate::i18n::tr_static("Loading installed and available apps...").dim(),
        ));
    ...
    fn connectors_popup_params(
        ...
        header.push(Line::from(crate::i18n::tr_static("Apps").bold()));
        header.push(Line::from(
            crate::i18n::tr_static("Use $ to insert an installed app into your prompt.").dim(),
        ));
        header.push(Line::from(
