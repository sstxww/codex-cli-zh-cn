...
impl MemoriesSettingsView {
        ...
        let mut view = Self {
            items: vec![
                MemoriesMenuItem::Setting {
                    ...
                    name: crate::i18n::tr_static("Use memories"),
                    description: crate::i18n::tr_static(
                ...
                MemoriesMenuItem::Setting {
                    ...
                    name: crate::i18n::tr_static("Generate memories"),
                    description: crate::i18n::tr_static(
                ...
                MemoriesMenuItem::Action {
                    ...
                    name: crate::i18n::tr_static("Reset all memories"),
                    description: crate::i18n::tr_static(
            ...
            docs_link: Line::from(vec![
                crate::i18n::tr_static("Learn more: ").dim(),
    ...
    fn settings_header(&self) -> ColumnRenderable<'_> {
        ...
        header.push(Line::from(crate::i18n::tr_static("Memories").bold()));
    ...
    fn reset_confirmation_header(&self) -> ColumnRenderable<'_> {
        let mut header = ColumnRenderable::new();
        header.push(Line::from(
            crate::i18n::tr_static("Reset all memories?").bold(),
        ));
        header.push(Line::from(
            crate::i18n::tr_static(
    ...
    fn build_rows(&self) -> Vec<GenericDisplayRow> {
        if let Some(state) = self.reset_confirmation.as_ref() {
            return ["Reset all memories", "Go back"]
                ...
                .enumerate()
                .map(|(idx, name)| {
                    let name = crate::i18n::tr_static(name);
                    GenericDisplayRow {
                        ...
                        description: Some(match idx {
                            0 => crate::i18n::tr_owned(
                                "Delete local memory files and rollout summaries.",
                            ),
                            1 => crate::i18n::tr_owned("Return to memory settings."),
    ...
    fn render(&self, area: Rect, buf: &mut Buffer) {
        ...
        if list_area.height > 0 {
            ...
            render_rows(
                ...
                self.active_state(),
                MAX_POPUP_ROWS,
                crate::i18n::tr_static("  No memory settings available"),
            );
        }
...
fn memories_settings_hint_line(keymap: &ListKeymap) -> Line<'static> {
    let mut spans = vec![
        crate::i18n::tr_static("Press ").into(),
        key_hint::plain(KeyCode::Char(' ')).into(),
        crate::i18n::tr_static(" to toggle").into(),
    ];
    if let Some(accept) = keymap.primary_hint(ListAction::Accept) {
        spans.extend([
            "; ".into(),
            accept.into(),
            crate::i18n::tr_static(" to save or select").into(),
        ]);
    }
    Line::from(spans)
}
