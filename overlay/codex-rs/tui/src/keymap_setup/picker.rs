...
fn build_keymap_rows(
    ...
    KEYMAP_ACTIONS
        ...
        .map(|descriptor| KeymapActionRow {
            ...
            context_label: crate::i18n::tr_static(descriptor.context_label),
            action: descriptor.action,
            label: action_label(descriptor.action),
            description: crate::i18n::tr_static(descriptor.description),
...
fn keymap_header(description: String, summary: String) -> Box<dyn Renderable> {
    ...
    header.push(Line::from(crate::i18n::tr_static("Keymap").bold()));
    header.push(Line::from(crate::i18n::tr_owned(description).dim()));
    header.push(Line::from(crate::i18n::tr_owned(summary).dim()));
    Box::new(header)
}
